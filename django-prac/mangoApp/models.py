...
class MangoappUser(models.Model):
    userid = models.CharField(db_column='userId', primary_key=True, max_length=20)  # Field name made lowercase.
    userpass = models.CharField(db_column='userPass', max_length=20)  # Field name made lowercase.

    class Meta:
        managed = False
        db_table = 'mangoApp_user'
